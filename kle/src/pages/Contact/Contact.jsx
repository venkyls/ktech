...
import klebelgaum from '../../utils/images/klebelgaum.jpeg';
import klehubli from '../../utils/images/klehubli.jpeg';
            ...
            <div className='container'>
                ...
                <div className='row g-4'>
                    <div className='col-lg-4 d-flex flex-column align-items-center'>
                        <img src={klehubli} className='img-fluid' alt="" />
                        <h3 className='text-center mt-3'>Hubli</h3>
                    </div>
                    <div className='col-lg-4 d-flex flex-column align-items-center'>
                        <img src={klebelgaum} className='img-fluid' alt="" />
                        <h3 className='text-center mt-3'>Belgaum</h3>
                    </div>
