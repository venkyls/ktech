...
const courses = [
    { id: 1, img: [start1], title: 'Lorem Ipsum', description: 'lorem ipsum' },
    { id: 2, img: [start2], title: '....', description: 'Lorem Ipsum' },
    { id: 3, img: [start3], title: '...', description: 'Lorem Ipusm' },
    { id: 4, img: [start6], title: '........', description: '....' },
    { id: 5, img: [start4], title: 'Lorem', description: '...' },
    { id: 6, img: [start5], title: 'Lorem', description: '...' },
];
    ...
    <div className='startups-page'>
        ...
        <div className='container py-5'>
            <div className='row g-4'>
                {courses.map((course) => (
                    <div key={course.id} className='col-lg-6'>
                         <Link to={`/courses/stup${course.id}`} className='text-decoration-none'>
                            <Card className='text-white shadow scale-hover-effect'>
                                <Card.Img src={course.img} />
                                <Card.ImgOverlay className='d-flex flex-column align-items-center justify-content-center p-md-5'>
                                    <Card.Title className='fs-1 text-danger'>{course.title}</Card.Title>
