  ...
  return (
    <div>
        <div className="container">
            <h2 className='text-center mb-5'>Why choose CTIE ?</h2>
            <div className='row g-4'>
                    ...
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                                KLE CTIE has just opened its new branch in Belgaum Campus paving a way for young bright minds to opt for enterpreneurship and innovations
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            <Card.Title className='text-center text-capitalize mb-3'>
                                Massive support for innovation
                            </Card.Title>
                            <Card.Text className='text-center'>
                                With all the amenities and support this is one stop where ur dreams grow!!
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            <Card.Title className='text-center text-capitalize mb-3'>
                                Support for investment and seed funding
                            </Card.Title>
                            <Card.Text className='text-center'>
